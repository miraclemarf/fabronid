...
function runDisplay() {
    ...
    if (maximum_per_page > page_count) {
        ...
        jQuery.each(obj, function(t, i) {
            console.log(t, i);
            console.log(jQuery.inArray(i.id.toString(), viewed));
            return -1 === jQuery.inArray(i.id.toString(), viewed) ? (display(i.buyer, i.city, i.province, i.country, i.created_at, i.product_title, i.image, i.url), viewed.unshift(i.id.toString()), finish = !0, e = !0, !1) : void 0
