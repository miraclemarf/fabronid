...
<div id="product-<?php the_ID(); ?>" <?php post_class("cepatlakoo-quick-view product-highlight"); ?>>
	<?php
		/**
	...
	?>
	    ...
	    <div class="single-product-highlight">
	    <?php
	        /**
        ...
        <?php
            /**
             * cepatlakoo_summary_product_highlight hook.
             *
             ...
             */
            do_action( 'cepatlakoo_summary_product_highlight' );
        ?>
        </div>
