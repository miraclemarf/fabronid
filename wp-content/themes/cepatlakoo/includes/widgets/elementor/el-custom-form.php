	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
		        ...
		        'size_units' => [ 'px', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .custom-form-area form' => 'width: {{SIZE}}{{UNIT}};',
		        ],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .custom-form-area form input[type="submit"], {{WRAPPER}} .custom-form-area form button',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#fff',
				'selectors' => [
					'{{WRAPPER}} .custom-form-area form input[type="submit"], {{WRAPPER}} .custom-form-area form button' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#c92f2f',
				'selectors' => [
					'{{WRAPPER}} .custom-form-area form input[type="submit"], {{WRAPPER}} .custom-form-area form button' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
		        ...
		        'size_units' => [ 'px', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .custom-form-area form input[type="submit"], {{WRAPPER}} .custom-form-area form button' => 'height: {{SIZE}}{{UNIT}};',
		        ],
			]
		);

		$this->add_control(
			'cepatlakoo_button_hover_border_color',
			[
				'label' => esc_html__( 'Button Border Hover Color', 'cepatlakoo' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .custom-form-area form input[type="submit"]:hover, {{WRAPPER}} .custom-form-area form button:hover' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'placeholder' => '1px',
				'default' => '0px',
				'selector' => '{{WRAPPER}} .custom-form-area button',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .custom-form-area button' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			'cepatlakoo_form_hover_border_color',
			[
				'label' => esc_html__( 'Form Border Hover Color', 'cepatlakoo' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .custom-form-area input:hover' => 'border-color: {{VALUE}};',
				],
			]
		);
